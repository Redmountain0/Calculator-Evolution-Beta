(function(){
  ...
  achievementGoal = [
    ...
    'Go singularity<br>Reward: CPU speed x25', 'Go singularity one more time<br>Reward: RP gain x10', 'Complete a challenge', 'Reach bulk ${dNotation(20, 0, 0)} Quantum Labs<br>Reward: Pow Quantum requirements by ^0.9', 'Complete ${dNotation(10, 0, 0)} Challenges<br>Reward: All Challenge requirement -2<br>Can bulk complete Challenge',
